...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        playerView = UIView(frame: CGRectMake(0 , 8, screenSize.width / 60, screenSize.height / 50))
        ...
        playerMotionManager.accelerometerUpdateInterval = 8.02
